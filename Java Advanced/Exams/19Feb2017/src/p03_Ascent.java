...
public class p03_Ascent {
    public static void main(String[] args) throws IOException {
        ...
        Map<String, String> foundPatterns = new LinkedHashMap<>();
        Pattern cypherPattern = Pattern.compile("([,_])([a-zA-Z]+)(\\d)");

        String line;
        while (!"Ascend".equalsIgnoreCase(line = reader.readLine())) {
            ...
            while (matcher.find()) {
                String decodedLine = decode(matcher.group(1), matcher.group(2), Integer.parseInt(matcher.group(3)));
