...
import static callofduty.Constants.*;
    ...
    private void initMissionClasses() {
        try {
            this.missionClasses = new LinkedHashMap<>() {{
                put("EscortMission", Class.forName(MISSIONS_PATH + "EscortMission"));
                put("HuntMission", Class.forName(MISSIONS_PATH + "HuntMission"));
                put("SurveillanceMission", Class.forName(MISSIONS_PATH + "SurveillanceMission"));
            }};
